...
function Months(month : string){
    switch(month){
        case 'Spring' : console.log("March");
                        console.log("Aprail");
                        break;

                        
        case 'Summer' : console.log("May");
        console.log("June");
        console.log("July");
        console.log("Augest");
        break;
        ...
        case 'Autumn' : console.log("September");
                        console.log("October");
        ...
        case 'Winter' : console.log("December");
                        console.log("January");
...
function Expression(operator:string , num1:number,num2 : number){
